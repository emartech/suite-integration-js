...
describe('Resize Handler', function() {
  ...
  it('should call window.getElementById when calling getIntegrationIframe with valid source', function() {
    messageHandler.getIntegrationIframe({
      integration_instance_id: integrationInstanceId
    });
    expect(fakeWindow.getElementById).to.have.been.calledWith('#integration-' + integrationInstanceId);
  });
